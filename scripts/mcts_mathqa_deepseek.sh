...
ACTOR_MODEL_NAME_OR_PATH="/mnt/miaohua/niuyazhe/model/DeepSeek-V2-Chat-0628"
ACTOR_REF_MODEL_NAME_OR_PATH="/mnt/miaohua/niuyazhe/model/DeepSeek-V2-Chat-0628"
OUTPUT_DIR="MCTS-DPO/outputs/checkpoints/arithmetic/deepseek-v2-chat-cdpo-2x2-gtsft"
